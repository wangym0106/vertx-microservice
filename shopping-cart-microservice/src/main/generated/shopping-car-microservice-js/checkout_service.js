...
/** @module shopping-car-microservice-js/checkout_service */
...
/**
 ...
 @memberof module:shopping-car-microservice-js/checkout_service
 @param vertx {Vertx} 
 @param discovery {ServiceDiscovery} 
 @return {CheckoutService}
 */
CheckoutService.createCheckoutService = function(vertx, discovery) {
  var __args = arguments;
  if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'object' && __args[1]._jdel) {
    return utils.convReturnVertxGen(CheckoutService, JCheckoutService["createCheckoutService(io.vertx.core.Vertx,io.vertx.servicediscovery.ServiceDiscovery)"](vertx._jdel, discovery._jdel));
  } else throw new TypeError('function invoked with invalid arguments');
};
