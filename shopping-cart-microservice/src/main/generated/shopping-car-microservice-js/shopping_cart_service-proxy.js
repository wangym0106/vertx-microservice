...
!function (factory) {
  if (typeof require === 'function' && typeof module !== 'undefined') {
    ...
    // AMD loader
    define('shopping-car-microservice-js/shopping_cart_service-proxy', [], factory);
  } else {
    // plain old include
  ...
  var ShoppingCartService = function(eb, address) {
    ...
    this.addCartEvent = function(cartEvent, resultHandler) {
      ...
      if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
        ...
        j_eb.send(j_address, {"cartEvent":__args[0]}, {"action":"addCartEvent"}, function(err, result) { __args[1](err, result &&result.body); });
        return that;
