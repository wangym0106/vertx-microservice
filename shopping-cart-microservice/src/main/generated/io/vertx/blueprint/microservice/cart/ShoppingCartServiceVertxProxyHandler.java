...
public class ShoppingCartServiceVertxProxyHandler extends ProxyHandler {
  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        case "addCartEvent": {
          service.addCartEvent(json.getJsonObject("cartEvent") == null ? null : new io.vertx.blueprint.microservice.cart.CartEvent(json.getJsonObject("cartEvent")), createHandler(msg));
          break;
        }
